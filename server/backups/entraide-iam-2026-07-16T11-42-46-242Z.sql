...
\restrict ueZlN5KNQWojXNkjs7wxnIseSLLeBrH7GwKY4KAlpThK41d8r8EzjBJJywaaxep
...
SELECT pg_catalog.setval('iam.audit_logs_id_seq', 42, true);
...
SELECT pg_catalog.setval('iam.connection_logs_id_seq', 53, true);
...
SELECT pg_catalog.setval('iam.system_logs_id_seq', 20, true);
...
\unrestrict ueZlN5KNQWojXNkjs7wxnIseSLLeBrH7GwKY4KAlpThK41d8r8EzjBJJywaaxep
